...
import (
	...
	repo "GO-GRPC-PRODUCT-SVC/pkg/repository/interface"
	usecase "GO-GRPC-PRODUCT-SVC/pkg/usecase/interface"
...
func NewProductUseCase(repository repo.ProductRepository) usecase.ProductUseCase {
