...
import (
	client "GO-GRPC-CART-SVC/pkg/client/interface"
	Repo "GO-GRPC-CART-SVC/pkg/repository/interface"
	usecase "GO-GRPC-CART-SVC/pkg/usecase/interface"
	"GO-GRPC-CART-SVC/pkg/utils/models"
	"errors"
)

type cartUseCase struct {
	cartRepository    Repo.CartRepository
	productRepository client.NewProductClient
}

func NewCartUseCase(repository Repo.CartRepository, productRepo client.NewProductClient) usecase.CartUseCase {
