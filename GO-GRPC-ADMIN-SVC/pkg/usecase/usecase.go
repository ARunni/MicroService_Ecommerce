...
import (
	...
	"GO-GRPC-ADMIN-SVC/pkg/helper"
	repo "GO-GRPC-ADMIN-SVC/pkg/repository/interface"
	usecase "GO-GRPC-ADMIN-SVC/pkg/usecase/interface"
...
func NewAdminUseCase(repository repo.AdminRepository) usecase.AdminUseCase {
	return &adminUseCase{
