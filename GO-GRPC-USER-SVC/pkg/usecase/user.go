...
import (
	...
	"GO-GRPC-USER-SVC/pkg/helper"
	repo "GO-GRPC-USER-SVC/pkg/repository/interface"
	usecase "GO-GRPC-USER-SVC/pkg/usecase/interface"
...
func NewUserUseCase(repository repo.UserRepository) usecase.UserUseCase {
	return &userUseCase{
