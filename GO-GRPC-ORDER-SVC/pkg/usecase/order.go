...
import (
	client "GO-GRPC-ORDER-SVC/pkg/client/interface"
	"GO-GRPC-ORDER-SVC/pkg/domain"
	repo "GO-GRPC-ORDER-SVC/pkg/repository/interface"
	usecase "GO-GRPC-ORDER-SVC/pkg/usecase/interface"
...
type orderUseCase struct {
	...
	cartRepository    client.CartClient
	productRepository client.ProductClient
}

func NewOrderUseCase(repository repo.OrderRepository, cartRepo client.CartClient, productRepo client.ProductClient) usecase.OrderUseCase {
	return &orderUseCase{
